...
import { listJobsSchema, statsQuerySchema, updateAssignmentStatusSchema } from './delivery.schema.js';
...
deliveryRouter.get('/stats', validateRequest(statsQuerySchema, 'query'), controller.stats);
...
deliveryRouter.post('/returns/:returnRequestId/accept', controller.acceptReturn);
